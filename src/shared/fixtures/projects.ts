...
export const PROJECT_ACTIVITY: ReadonlyArray<ProjectActivityEvent> = [
  {
    ...
    projectId: 'prj_orch',
    kind: 'memory',
    title: 'attempt_lessons updated',
    actor: 'orchestrator',
    createdAt: '2026-06-14T09:20:00Z',
    summary: 'Stored reviewer lesson about release notes as a reusable fact for future developer attempts.',
    target: 'attempt_lessons',
    runId: 'run_0f12',
  },
  {
    ...
    projectId: 'prj_orch',
    kind: 'knowledge',
    title: 'Sidebar project switcher behavior added',
    actor: 'kap',
    createdAt: '2026-06-14T09:50:00Z',
    summary: 'Documented dropdown behavior, project initials, system control plane, and browse action.',
    target: 'Sidebar project switcher behavior',
  },
  {
    id: 'act_orch_adr_switcher',
    projectId: 'prj_orch',
    kind: 'adr',
    title: 'ADR-15 proposed',
    actor: 'kap',
    createdAt: '2026-06-14T08:45:00Z',
    summary: 'Captured the local-state decision for the project switcher until the project API exists.',
    target: 'Workspace switcher is local state until project API exists',
    runId: 'run_8f2a',
  },
  {
    ...
    projectId: 'prj_orch',
    kind: 'run',
    title: 'Run lesson captured',
    actor: 'reviewer',
    createdAt: '2026-06-13T11:05:00Z',
    summary: 'Reviewer requested changes because changelog generation was not wired into the release path.',
    target: 'Release automation cleanup',
    runId: 'run_0f12',
  },
  {
